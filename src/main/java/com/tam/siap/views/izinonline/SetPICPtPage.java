...
@Route(value = "setpicpt", layout = HomePageIzinOnline2.class)
public class SetPICPtPage extends VerticalLayout {

	/**
	 * @author AHMADT
	 */
	private static final long serialVersionUID = -7553805264111526574L;
	private TextField txtnamapicpt = new TextField("Nama");
	private TextField txtemailpicpt = new TextField("Email");
	private TextField txtktppicpt = new TextField("KTP");
	private TextField txtjabatanpicpt = new TextField("Jabatan");
	private TextField txthandphonepicpt = new TextField("Handphone");
	private TextField txtpasswordpicpt = new TextField("Password");
	private ComboBox<Perusahaan> comboPT = new ComboBox<Perusahaan>("Perusahaan");
	private Button btnsave = new Button("Simpan");
	private Button btndel = new Button("Delete");
	private Button btncancel = new Button("Cancel");
	private Grid<PicPerusahaan> gridpicpt = new Grid<PicPerusahaan>();
	private List<PicPerusahaan> listpicperusahaan = new ArrayList<PicPerusahaan>();
	...
	private Component popupAddPIC(PicPerusahaan pic,Dialog d) {
		...
		btnsave.addClickListener(new ComponentEventListener<ClickEvent<Button>>() {
			...
			public void onComponentEvent(ClickEvent<Button> event) {
				...
				d.close();
				getUI().get().navigate(SetPICPtPage.class);	
			}
		});
